...
import { threadInfo } from '@/data/threadInfo';
...
export default async function ThreadPage({
  ...
  return (
    <section className='bg-interex-bg-thread p-6'>
      ...
      <h2 className={`${saira.className} font-semibold text-2xl py-4`}>How can i improve as a support main?</h2>

      {/* Thread Main Discussion */}
      <div className='grid grid-cols-[80px,_1fr]'>
        {/* Thread Upvotes */}
        ...
        <div className='px-4'>
          ...
          <div className='flex items-center'>
            <h3 className={`${saira.className} mb-1 font-semibold text-interex-aqua text-xl mr-3`}>ObliqueSanta</h3>
            {/* Member Role */}
            <CommunityRole role='Moderator' />
          </div>
          ...
          {/* Thread Topic */}
          <p className='whitespace-pre-wrap'>{threadInfo}</p>
        </div>
      </div>
