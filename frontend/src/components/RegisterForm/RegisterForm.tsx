...
const RegisterForm = () => {
  ...
  const username = useFormInputText();
  const password = useFormInputText();
  const confirmPassword = useFormInputText();
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const user = await AuthService.register(email.value, username.value, password.value);

    if (!user) {
      alert('Did not sign up correctly.')
    }
  ...
  return (
    ...
    >
      ...
      <AuthInput
        ...
        handleInputChange={username.handleChange}
      />
      <AuthInput
        title='Password'
        inputType='password'
      ...
      <AuthInput
        ...
        handleInputChange={confirmPassword.handleChange}
      />
